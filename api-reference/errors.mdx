---
title: "API Errors: HTTP Status Codes and Validation Rules"
sidebarTitle: "Errors"
description: "Error response formats, HTTP status codes, validation error shapes, and exact error messages returned by the Buda Lightning Invoice API endpoints."
---
