...
sidebarTitle: "GET /lnurlp/:username"
description: "GET /.well-known/lnurlp/:username returns LNURL-pay metadata for Lightning Address support. Used by wallets to discover payment parameters before requesting an invoice."
---
